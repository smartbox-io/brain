class CellVolume < ApplicationRecord
  ...
  has_many :sync_source_tokens, foreign_key: :source_cell_volume_id, class_name: "SyncToken", dependent: :destroy
  has_many :sync_target_tokens, foreign_key: :target_cell_volume_id, class_name: "SyncToken", dependent: :destroy
